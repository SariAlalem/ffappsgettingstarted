...
// Sets the install button that appears on the top right corner
...
// Functions to handle clicks and animate UI
...
{
if(element.style.width=="50px" || element.style.width =="")
{
...
function animate(element,width,height)
{
...
{
	leftPosition-=350;
	document.getElementById("bodyDiv").style.left= (leftPosition)+"px";
}
function previous()
{
	leftPosition+=350;
